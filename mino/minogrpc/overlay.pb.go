...
func (m *SendMessage) GetMessage() *any.Any {
	if m != nil {
		return m.Message
	}
	return nil
...
func (m *SendResponse) GetMessage() *any.Any {
	if m != nil {
		return m.Message
	}
	return nil
...
func init() {
	proto.RegisterType((*SendMessage)(nil), "minogrpc.SendMessage")
	proto.RegisterType((*SendResponse)(nil), "minogrpc.SendResponse")
}
...
var fileDescriptor_61fc82527fbe24ad = []byte{
	...
	0xa6, 0xe9, 0x27, 0xe6, 0x41, 0x15, 0x29, 0xd9, 0x72, 0x71, 0x07, 0xa7, 0xe6, 0xa5, 0xf8, 0xa6,
	0x16, 0x17, 0x27, 0xa6, 0xa7, 0x0a, 0xe9, 0x71, 0xb1, 0xe7, 0x42, 0x98, 0x12, 0x8c, 0x0a, 0x8c,
	0x1a, 0xdc, 0x46, 0x22, 0x7a, 0x10, 0xbd, 0x7a, 0x30, 0xbd, 0x7a, 0x8e, 0x79, 0x95, 0x41, 0x30,
	0x45, 0x4a, 0x76, 0x5c, 0x3c, 0x20, 0xed, 0x41, 0xa9, 0xc5, 0x05, 0xf9, 0x79, 0xc5, 0x24, 0xeb,
	0x37, 0x72, 0xe2, 0x62, 0xf7, 0x87, 0x38, 0x5a, 0xc8, 0x9c, 0x8b, 0x05, 0x64, 0x94, 0x90, 0xa8,
	0x1e, 0xcc, 0xdd, 0x7a, 0x48, 0x2e, 0x93, 0x12, 0x43, 0x15, 0x86, 0xd9, 0xa8, 0xc4, 0x90, 0xc4,
	0x06, 0x36, 0xda, 0x18, 0x10, 0x00, 0x00, 0xff, 0xff, 0x46, 0x53, 0xef, 0xd8, 0xff, 0x00, 0x00,
	0x00,
}
...
type OverlayClient interface {
	Send(ctx context.Context, in *SendMessage, opts ...grpc.CallOption) (*SendResponse, error)
}
...
func (c *overlayClient) Send(ctx context.Context, in *SendMessage, opts ...grpc.CallOption) (*SendResponse, error) {
	out := new(SendResponse)
	err := c.cc.Invoke(ctx, "/minogrpc.Overlay/Send", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type OverlayServer interface {
	Send(context.Context, *SendMessage) (*SendResponse, error)
}
...
func (*UnimplementedOverlayServer) Send(ctx context.Context, req *SendMessage) (*SendResponse, error) {
...
func _Overlay_Send_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SendMessage)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(OverlayServer).Send(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/minogrpc.Overlay/Send",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OverlayServer).Send(ctx, req.(*SendMessage))
	}
