...
//  go install
//
//  memcoin --config /tmp/node1 start --listen 127.0.0.1:2001 &
//  memcoin --config /tmp/node2 start --listen 127.0.0.1:2002 &
//  memcoin --config /tmp/node3 start --listen 127.0.0.1:2003 &
//
